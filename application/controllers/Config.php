...
class Config extends Secure_Controller
{
	...
	*/
	...
	public function ajax_check_number_locale_alt()
	{
		...
		$currency_symbol_alt = empty($this->input->post('currency_symbol_alt')) ? '' : $this->input->post('currency_symbol_alt');
		$exchange_rate_set = array(TRUE, 1.0, $number_locale_alt, $currency_symbol_alt);
		$number_local_example_alt = to_currency(1234567890.12300, $exchange_rate_set);
		echo json_encode(array(
